...
export default function DelegationControlPanel({ investigationId = 'INV-2026-001' }) {
  ...
  return (
    <div className="p-5 rounded-xl border border-border/60 bg-card space-y-4 font-mono">
      ...
      {msg && (
        <div className="p-3 bg-[#E9F7EF] dark:bg-[#2E8B57]/20 border border-[#A2E2BB] dark:border-[#2E8B57]/40 text-[#2E8B57] dark:text-[#34D399] text-xs rounded-lg flex items-center gap-2">
